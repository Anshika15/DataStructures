...
public class Main {
  ...
  public static void pathSum(TreeNode root, int targetSum, ArrayList<ArrayList<Integer>> res, ArrayList<Integer> smallAns) {
      ...
      if(root.left == null && root.right == null)
      {
          ...
          {
              ArrayList<Integer> l = new ArrayList<>(smallAns);
              l.add(root.val);
              res.add(l);
          }
          return;
